...
- :guilabel:`Company`: from the drop-down menu in this field, select the company the new employee
  was hired by, or create a new company by typing the name in the field, and click
...
- Work Contact Information: enter the employee's :guilabel:`Work Mobile`, :guilabel:`Work Phone`,
  :guilabel:`Work Email`, and/or :guilabel:`Company` name, if not already auto-populated.
...
.. important::
   Only user's with :guilabel:`Officer: Manage all employees` or :guilabel:`Administrator` rights
   for the *Employees* app can add or edit skills.
...
.. tip::
   Once the form is completely filled out, click the :guilabel:`Save manually` icon at the top of
   the screen and the :guilabel:`Levels` rearrange in descending order, with the highest level at
...
- :guilabel:`Status`: select an :guilabel:`Employee Type` and, if applicable, a :guilabel:`Related
  ...
  .. important::
     ...
     (pencil)` icon) in the lower-left corner of the image box, which is located in the top-right of
     the form.
